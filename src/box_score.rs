...
#[serde(rename_all = "camelCase")]
pub struct BoxScore {
    assist: Option<TopPlayerByValue>,
    blocks: Option<TopPlayerByValue>,
    fouled: Option<TopPlayerByValue>,
    fouler: Option<TopPlayerByValue>,
    steals: Option<TopPlayerByValue>,
    turnovers: Option<TopPlayerByValue>,
    points: Option<TopPlayerByValue>,
    paint_points: Option<TopPlayerByValue>,
    threes: Option<TopPlayerByValue>,
    rebounds: Option<TopPlayerByValue>,
    off_rebounds: Option<TopPlayerByValue>,
    def_rebounds: Option<TopPlayerByValue>,
}

impl BoxScore {
    pub fn try_from_value(value: Value) -> Option<Self> {
        let stats: Vec<StatPlayer> = serde_json::from_value(value.clone()).map_err(|e| {
            std::fs::write("box_score_calc_err.json", serde_json::to_string_pretty(&value).unwrap()).unwrap();
            e
        }).unwrap();
        ...
        for stat in stats {
            ...
            ret.update_paint_points(stat.player_name.clone(), stat.statistics.points_in_the_paint);
            ret.update_threes(stat.player_name.clone(), stat.statistics.three_pointers_made);
    ...
    fn update_assist(&mut self, name: String, value: u8) {
        if let Some(v) = self.assist.as_mut() {
            ...
            self.assist = Some(TopPlayerByValue {
                name,
                value,
            })
        }
    ...
    fn update_blocks(&mut self, name: String, value: u8) {
        if let Some(v) = self.blocks.as_mut() {
            ...
            self.blocks = Some(TopPlayerByValue {
                name,
                value,
            })
        }
    ...
    fn update_fouled(&mut self, name: String, value: u8) {
        if let Some(v) = self.fouled.as_mut() {
            ...
            self.fouled = Some(TopPlayerByValue {
                name,
                value,
            })
        }
    ...
    fn update_fouler(&mut self, name: String, value: u8) {
        if let Some(v) = self.fouler.as_mut() {
            ...
            self.fouler = Some(TopPlayerByValue {
                name,
                value,
            })
        }
    ...
    fn update_steals(&mut self, name: String, value: u8) {
        if let Some(v) = self.steals.as_mut() {
            ...
            self.steals = Some(TopPlayerByValue {
                name,
                value,
            })
        }
    ...
    fn update_turnovers(&mut self, name: String, value: u8) {
        if let Some(v) = self.turnovers.as_mut() {
            ...
            self.turnovers = Some(TopPlayerByValue {
                name,
                value,
            })
        }
    ...
    fn update_points(&mut self, name: String, value: u8) {
        if let Some(v) = self.points.as_mut() {
            ...
            self.points = Some(TopPlayerByValue {
                name,
                value,
            })
        }
    ...
    fn update_paint_points(&mut self, name: String, value: u8) {
        if let Some(v) = self.paint_points.as_mut() {
            ...
            self.paint_points = Some(TopPlayerByValue {
                name,
                value,
            })
        }
    ...
    fn update_threes(&mut self, name: String, value: u8) {
        if let Some(v) = self.threes.as_mut() {
            ...
            self.threes = Some(TopPlayerByValue {
                name,
                value,
            })
        }
    ...
    fn update_rebounds(&mut self, name: String, value: u8) {
        if let Some(v) = self.rebounds.as_mut() {
            ...
            self.rebounds = Some(TopPlayerByValue {
                name,
                value,
            })
        }
    ...
    fn update_off_rebounds(&mut self, name: String, value: u8) {
        if let Some(v) = self.off_rebounds.as_mut() {
            ...
            self.off_rebounds = Some(TopPlayerByValue {
                name,
                value,
            })
        }
    ...
    fn update_def_rebounds(&mut self, name: String, value: u8) {
        if let Some(v) = self.def_rebounds.as_mut() {
            ...
            self.def_rebounds = Some(TopPlayerByValue {
                name,
                value,
            })
        }
